...
import { faUser, faSignOutAlt, faBell, faCube, faComment } from '@fortawesome/free-solid-svg-icons';
    ...
    return(
        <div className="navbar flex fixed w-full justify-between py-4 px-3 lg:px-48 bg-white">
            <div className="justify-start flex">
                ...
                <p className="hidden sm:block text-sm text-black py-1 ml-2 px-2 rounded-lg hover:bg-gray-100 cursor-pointer">Resources</p>
            </div>
            <div className="options justify-between flex">
                <span className="text-xs font-semibold py-1 px-3 rounded-lg bg-gray-100 hover:bg-gray-200 cursor-pointer flex"> <FontAwesomeIcon className="w-2.5" icon={faComment} fixedWidth/></span>
